...
print("Trenowanie algorytmu K-Means dla 7 klastrów...")
...
plt.title('Profil Godzinowy (7 Klastrów)', fontsize=13, fontweight='bold')
...
plt.title('Czas podróży (7 Klastrów)', fontsize=13, fontweight='bold')
plt.xlabel('Wyznaczony Klaster (Grupa)')
plt.ylabel('Czas trwania podróży (minuty)')
plt.tight_layout()

plot1_path = 'data/processed/klastry_7k_godzina.png'
...
plt.title('Zależność pory dnia od temperatury (7 Klastrów)', fontsize=14, fontweight='bold')
plt.xlabel('Godzina w ciągu dnia')
...
plot2_path = 'data/processed/klastry_7k_pogoda.png'
...
legend_labels = [f"Profil {i}" for i in range(7)]

plt.figure(figsize=(12, 6))
cluster_evolution_pct.plot(kind='bar', stacked=True, figsize=(11, 6), cmap=color_palette, edgecolor='black',
                           linewidth=1)

plt.title('Ewolucja profili użytkowników z 7 klastrami (2019 - 2022)', fontsize=14, fontweight='bold')
plt.xlabel('Rok')
...
plot3_path = 'data/processed/klastry_7k_rok.png'
